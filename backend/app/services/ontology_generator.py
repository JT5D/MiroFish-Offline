...
- Representatives of specific groups (such as alumni associations, fan groups, rights advocacy groups, etc.)
...
B. **Specific types (8, designed based on text content)**:
   ...
   - For example: if the text involves commercial events, you can have `Company`, `CEO`, `Employee`

**Why fallback types are needed**:
- Various people will appear in the text, such as "elementary school teachers", "passersby", "some netizen"
...
- Organization: Any organization/institution (used when not belonging to the above specific types)
...
4. All entity types must be real-world subjects that can speak publicly, not abstract concepts
