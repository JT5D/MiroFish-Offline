...
class InsightForgeResult:
    ...
    Contains retrieval results from multiple sub-queries, as well as comprehensive analysis
    """
    query: str
...
class GraphToolsService:
    ...
    - get_all_edges - Get all edges of the graph (with temporal information)
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """Get all edges of the graph (with temporal information)"""
...
Return a JSON-formatted list of sub-questions."""
    ...
    def interview_agents(
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "and respond to the following questions directly in plain text.\n"
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean JSON tool call wrappers from Agent responses, extracting the actual content"""
