...
Reads nodes from the Neo4j graph and filters out nodes matching predefined entity types
...
class EntityReader:
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Retrieved {len(nodes)} nodes in total")
        return nodes
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Retrieved {len(edges)} edges in total")
        return edges
    ...
    def get_entity_with_context(
        ...
        """
        Get a single entity with its complete context (edges and associated nodes)
