...
class TimeSimulationConfig:
    """Time simulation configuration (based on standard daily schedule)"""
    ...
    # Peak hours (evening 19-22, the most active period)
...
- Follow a standard daily schedule pattern
- Almost no activity during early morning 0-5 AM (activity multiplier 0.05)
- Gradually active in the morning 6-8 AM (activity multiplier 0.4)
- Moderately active during work hours 9 AM-6 PM (activity multiplier 0.7)
- Peak period in the evening 7-10 PM (activity multiplier 1.5)
- Activity declines after 11 PM (activity multiplier 0.5)
- General pattern: low activity in early morning, gradually increasing in morning, moderate during work hours, evening peak
- **Important**: The example values below are for reference only. You need to adjust specific time periods based on the nature of the event and characteristics of the participant groups
  - Example: Student groups may peak at 9-11 PM; media may be active all day; official institutions only during work hours
  - Example: Breaking news may cause late-night discussion, off_peak_hours can be shortened accordingly
...
- reasoning (string): Brief explanation of why this configuration was chosen"""
        ...
        system_prompt = "You are a social media simulation expert. Return pure JSON format. Use a standard daily activity schedule."
...
- **Schedule follows standard daily routine**: Almost no activity from midnight to 5 AM, most active in the evening 7-10 PM
...
{{
    "agent_configs": [
        {{
            ...
            "active_hours": [<list of active hours based on daily routine>],
        ...
        system_prompt = "You are a social media behavior analysis expert. Return pure JSON. Use a standard daily activity schedule."
    ...
    def _generate_agent_config_by_rule(self, entity: EntityNode) -> Dict[str, Any]:
        """Generate a single Agent configuration by rules"""
